...
// Mice with both angle and proximty sensors with 4 hidden neurons on the feedforward net
// Greg Jones 15/3/04 
...
public:
	...
	{
		double o = This.Sensors["proximity"]->GetOutput();
//		double o2 = This.Sensors["angle"]->GetOutput();
...
public:
 ...
 //2 inputs
	...
	virtual void Control()
	{
		This.myBrain.SetInput(0, This.Sensors["proximity"]->GetOutput());
		This.myBrain.SetInput(1, This.Sensors["angle"]->GetOutput());
